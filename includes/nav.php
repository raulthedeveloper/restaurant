<?php include $path !== 'pages' ? "functions/nav_links.php" : "../functions/nav_links.php" ;?>


<nav class="navbar navbar-expand-lg navbar-dark"  <?php nav_style(); ?>>
  <a class="navbar-brand" style="display:initial" href="<?php echo $path == 'pages' ? '../index.php' : null ?>">EL Restaurante</a>
